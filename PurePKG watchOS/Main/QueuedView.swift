            ...
            VStack(alignment: .leading) {
                ...
                HStack {
                    ...
                    Button(action: {
                        ...
                        Spacer()
                        Text(showLog ? "Close" : "Install Queued").padding().font(.footnote)
                        Spacer()
                    }).buttonStyle(.borderedProminent).tint(.accentColor.opacity(0.05)).cornerRadius(8)
                    Spacer()
                }
            }.listStyle(.plain)
        }
